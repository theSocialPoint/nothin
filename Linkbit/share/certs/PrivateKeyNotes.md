...
unlocked to sign the Linkbit-Qt.app bundle.
...
allowing somebody to distribute a Linkbit-Qt.app or linkbit-qt-setup.exe with a valid
...
that the linkbit-qt.exe file inside the installer had not been tampered with.
